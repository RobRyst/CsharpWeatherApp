        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Timezone = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OpenWeatherCityId = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeelsLikeTemperature = table.Column<int>(type: "int", nullable: false),
                    ...
                    Sunrise = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    Sunset = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
